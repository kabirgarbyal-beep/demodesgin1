    ...
    <section id="contact" className="relative overflow-hidden bg-charcoal px-6 py-20 text-ivory lg:px-16 lg:py-28">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <h2 className="mt-6 font-display text-[clamp(2.5rem,7vw,7rem)] leading-[0.95] tracking-tight">
            <MaskReveal>Let's compose</MaskReveal>
            <br />
            <MaskReveal><em className="italic text-gold-soft">your quiet retreat.</em></MaskReveal>
          </h2>
          <Reveal delay={0.3}>
            <p className="mx-auto mt-7 max-w-xl text-base leading-[1.8] text-ivory/65 md:text-lg">
          ...
          <Reveal delay={0.5}>
            <a
              ...
              className="group relative mt-9 inline-flex items-center gap-4 overflow-hidden rounded-full bg-gold px-10 py-5 text-[11px] uppercase tracking-[0.32em] text-ink"
            >
        ...
        <Reveal delay={0.6}>
          <div className="mx-auto mt-14 grid max-w-5xl grid-cols-1 gap-px overflow-hidden rounded-sm border border-ivory/10 bg-ivory/10 md:grid-cols-3">
